      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-11 items-center">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-purple-200/50 group cursor-pointer"
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <h3 className="text-white text-2xl font-bold">A Message from Our Founder</h3>
            ...
            <motion.div 
              ...
              className="absolute -top-6 -right-6 w-24 h-24 bg-pink-500/20 rounded-full blur-xl"
          ...
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4 leading-tight">
              ...
              <span className="text-purple-600"> Passion</span> for 
            ...
            <div className="flex items-center gap-3 mb-5 p-3 bg-white rounded-2xl shadow-lg">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm">MBA, Oxford University</p>
